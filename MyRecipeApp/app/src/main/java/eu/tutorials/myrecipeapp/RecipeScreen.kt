...
import eu.tutorials.myrecipeapp.data.Category
import eu.tutorials.myrecipeapp.model.MainViewModel
...
fun CategoryItem(category: Category,navController: NavController){
    Box(modifier = Modifier.clickable {
        navController.navigate("mealListByCategory/${category.strCategory}")
    }) {
